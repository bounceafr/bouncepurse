...
export const SectionCards = ({ cards }: { cards: SectionCardData[] }) => {
    return (
        <StaggerChildren className="grid grid-cols-1 gap-4 *:data-[slot=card]:bg-gradient-to-br *:data-[slot=card]:from-primary/8 *:data-[slot=card]:via-card *:data-[slot=card]:to-card *:data-[slot=card]:shadow-xs @xl/main:grid-cols-2 @5xl/main:grid-cols-4 dark:*:data-[slot=card]:bg-card dark:*:data-[slot=card]:from-primary/12">
            {cards.map((card) => (
